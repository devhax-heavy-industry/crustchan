...
pub async fn create_board_handler(_token: AuthnToken, json_body:  HashMap<String, String> ) -> WebResult {
...
pub async fn login_handler(json_body: HashMap<String, String>) -> Result<WithHeader<GenericResponse>, Rejection> {
    info!("login_handler:");
