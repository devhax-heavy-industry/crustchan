...
resource "aws_iam_role_policy_attachment" "rekognition_service_role_policy_attach" {
   role       = "${aws_iam_role.api_server_role.name}"
   policy_arn = "${data.aws_iam_policy.rekognition_service_role.arn}"
}
# resource "aws_iam_role_policy_attachment" "rekognition_service_role_policy_attach" {
#    role       = "${aws_iam_role.api_server_role.name}"
#    policy_arn = "${data.aws_iam_policy.s3_write_access.arn}"
# }
...
resource "aws_iam_role_policy_attachment" "dynamodb_service_role_policy_attach" {
   role       = "${aws_iam_role.app_lambda_role.name}"
